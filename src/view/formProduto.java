...
public class formProduto extends javax.swing.JFrame {
    ...
    private void atualizarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarProdutoActionPerformed
        // TODO add your handling code here:
        try {
            boolean result = dbProduto.atualizar(getProduto());
        } catch (Exception ex) {
    ...
    private Produto getProduto() throws Exception{
     ...
     public void setCodigo(boolean id) throws Exception{
        int codigo = 0;
        if(id){
            codigo = this.dbProduto.ultimoCodigo();
    ...
    DAOProduto dbProduto = new DAOProduto();
